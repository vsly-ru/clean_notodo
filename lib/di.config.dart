...
import 'core/router/app_router.dart' as _i20;
...
import 'features/auth/presentation/cubit/login_cubit.dart' as _i23;
...
import 'features/todos/domain/usecases/add_update_todo.dart' as _i19;
import 'features/todos/domain/usecases/get_one_todo.dart' as _i21;
import 'features/todos/domain/usecases/get_todo_list.dart' as _i22;
...
import 'features/todos/presentation/cubit/todo_list_cubit.dart' as _i18;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i18.TodoListCubit>(
      () => _i18.TodoListCubit(get<_i9.ITodoRepository>()));
  gh.factory<_i19.AddUpdateTodoUC>(
      () => _i19.AddUpdateTodoUC(get<_i9.ITodoRepository>()));
  gh.factory<_i20.AppRouter>(() =>
      _i20.AppRouter(get<_i3.AppStateManager>(), get<_i7.IDelegatedActions>()));
  gh.factory<_i21.GetOneTodoUC>(
      () => _i21.GetOneTodoUC(get<_i9.ITodoRepository>()));
  gh.factory<_i22.GetTodoListUC>(
      () => _i22.GetTodoListUC(get<_i9.ITodoRepository>()));
